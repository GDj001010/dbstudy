...
SELECT
       TO_CHAR(100)             -- '100'
     , TO_CHAR(100, '999999')   -- '   100'  999999는 공백을 채움
     , TO_CHAR(100, '000000')   -- '000100'  000000은 0을 채움
...
-- 어떤 날짜를 어떤 방법으로 해석해야 하는지 알려주는 함수가 TO_DATE 함수
SELECT
       TO_DATE('05/06/07', 'YY/MM/DD') -- 2005년 6월 7일
     , TO_DATE('05/06/07', 'MM/DD/YY')  -- 2007년 5월 6일
  FROM
       DUAL;
