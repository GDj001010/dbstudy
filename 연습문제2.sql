...
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '축구의 역사', '굿스포츠', '7000');
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '축구 아는 여자', '나이스북', '13000');
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '축구의 이해', '대한미디어', '22000');
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '골프 바이블', '대한미디어', '35000');
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '피겨 교본 ', '굿스포츠', '6000');
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '역도 단계별 기술', '굿스포츠', '6000');
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '야구의 추억', '이상미디어', '20000');
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '야구를 부탁해', '이상미디어', '13000');
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '올림픽 이야기', '삼성당', '7500');
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUE (BOOK_SEQ.NEXTVAL, '올림픽 챔피언', '나이스북', '13000');
COMMIT;
...
INSERT INTO CUSTOMER_TBL (CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE) VALUE (CUSTOMER_SEQ.NEXTVAL, '박지성', '영국', '000-000-000');
INSERT INTO CUSTOMER_TBL (CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE) VALUE (CUSTOMER_SEQ.NEXTVAL, '김연아', '대한민국', '111-111-111');
INSERT INTO CUSTOMER_TBL (CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE) VALUE (CUSTOMER_SEQ.NEXTVAL, '장미란', '대한민국', '222-222-222');
INSERT INTO CUSTOMER_TBL (CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE) VALUE (CUSTOMER_SEQ.NEXTVAL, '추신수', '미국', '333-333-333');
INSERT INTO CUSTOMER_TBL (CUSTOMER_ID, CUSTOMER_NAME, ADDRESS) VALUE (CUSTOMER_SEQ.NEXTVAL, '박세리', '대한민국');
