...
-- 사용자 함수 FUNC3 정의
-- 사원번호를 전달하면 해당 사원의 연봉이 15000 이상이면 '고액연봉', 아니면 '보통연봉'
...
-- 함수 MY_CEIL 호출
SELECT
        MY_FLOOR(999.999, 2)         -- 소수2자리 내림
      , MY_FLOOR(999.999, 1)         -- 소주1자리 내림
      , MY_FLOOR(999.999, 0)         -- 정수로 내림
      , MY_FLOOR(999.999, -1)        -- 일의자리 내림
      , MY_FLOOR(999.999, -2)        -- 십의자리 내림
  FROM DUAL;
